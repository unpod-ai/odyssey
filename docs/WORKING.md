...
- **LlamaIndex hooks and the OTel bridge are not started** (0.10/0′.3). LangChain
  and LangGraph are both covered (0.10/0′.2) — LangGraph needed no additional
  code, only verification that it dispatches the same callback tree.
